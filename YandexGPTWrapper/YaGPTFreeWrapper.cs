...
{
    public class YaGPTFreeWrapper : WSocket, IDisposable
    {
        ...
        public YaGPTFreeWrapper(string language = Language.Russian, CancellationToken? cancelationToken = null) : base(cancelationToken)
        {
